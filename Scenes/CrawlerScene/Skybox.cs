...
using static AngelPearl.Scenes.CrawlerScene.MapRoom;
...
namespace AngelPearl.Scenes.CrawlerScene
{
    public class Skybox
    {
        private const float SKYBOX_LENGTH = 75;
        ...
        {   
            ...
            },
            {
                ...
                {
                    new (SKYBOX_LENGTH, -6, SKYBOX_LENGTH),
                    new (SKYBOX_LENGTH, -6, -SKYBOX_LENGTH),
                    new (-SKYBOX_LENGTH, -6, -SKYBOX_LENGTH),
                    new (-SKYBOX_LENGTH, -6, SKYBOX_LENGTH)
                }
            },
            {
                ...
                {
                    new (SKYBOX_LENGTH, 4, -SKYBOX_LENGTH),
                    new (SKYBOX_LENGTH, 4, SKYBOX_LENGTH),
                    new (-SKYBOX_LENGTH, 4, SKYBOX_LENGTH),
                    new (-SKYBOX_LENGTH, 4, -SKYBOX_LENGTH)
                }
        ...
        public Skybox(string skyboxName)
        {
            ...
            foreach (Direction direction in directionList)
            {
                ...
                RoomWall roomWall = new RoomWall(direction, skyboxTexture, VERTICES, 0.0f, 0.0f, 15.0f, 15.0f)
                {
					Shader = new WallShader(Matrix.CreatePerspectiveFieldOfView(Floor.PERSPECTIVE_FOV, Floor.PERSPECTIVE_ASPECT, 0.7f, 10000.0f))
					{
