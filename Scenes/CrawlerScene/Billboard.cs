...
namespace AngelPearl.Scenes.CrawlerScene
{
    public class Billboard
    {
        ...
        public BillboardShader Shader { get; set; }
        ...
        public Billboard(CrawlerScene mapScene, Floor iFloor, Texture2D sprite, float sizeWidth, float sizeHeight, float heightOffset = 0)
        {
            ...
            Shader = new BillboardShader(Matrix.CreatePerspectiveFieldOfView(Floor.PERSPECTIVE_FOV, Floor.PERSPECTIVE_ASPECT, 0.7f, 10000.0f));
        ...
        public void Draw(Matrix viewMatrix, float x, float z, float rotation, float brightness)
        {
            ...
            Shader.Brightness = brightness * parentScene.GlobalBrightness;
