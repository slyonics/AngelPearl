...
namespace AngelPearl.Scenes.CrawlerScene
{
    public class Door : IBillboard
    {
        ...
        public Door(CrawlerScene iScene, Floor iFloor, EntityInstance entity)
        {
            crawlerScene = iScene;
            ...
            foreach (FieldInstance field in entity.FieldInstances)
            {
                ...
                {
                    case "Sprite": Item = field.Value; break;
            ...
            float sizeY = texture.Height * 3.2f / 9;
