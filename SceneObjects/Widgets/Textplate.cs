...
namespace AngelPearl.SceneObjects.Widgets
{
	public class Textplate : Widget
	{
		...
		public override void ApplyAlignment()
		{
			...
			int width = Main.Text.GetStringLength(Font, longestLine) + InnerMargin.X + InnerMargin.Width + 15; // Math.Max(Text.GetStringLength(font, text) + TOOLTIP_MARGIN_WIDTH * 2, textplateFrame.FrameWidth * 3) + 20;
			...
			textplateFrame.FrameDepth = Depth;
		}
