...
namespace AngelPearl
{
	public static class Extensions
	{
		...
		public static Rectangle[] BuildSources(int cellCount, int cellWidth, int cellHeight)
		{
			var result = new Rectangle[cellCount];
			for (int i = 0; i < cellCount; i++)
			{
				result[i] = new Rectangle(i * cellWidth, 0, cellWidth, cellHeight);
			}
			return result;
		}
	}
